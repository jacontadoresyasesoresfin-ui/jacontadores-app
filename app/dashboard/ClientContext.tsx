...
export const ALL_MODULES = [
    ...
    'nomina', 'nit', 'causacion', 'conciliaciones', 'exogenas',
...
export const DEFAULT_MODULES: Record<string, boolean> = {
    ...
    taxes: true, configuracion: true, nomina: true, nit: true, causacion: true, conciliaciones: true, exogenas: true,
...
export function getModules(profile: Profile | null, tenant?: Tenant | null): Record<string, boolean> {
    ...
    if (profile.app_modules && Array.isArray(profile.app_modules) && profile.app_modules.length > 0) {
        ...
        // Perfiles creados antes de que se añadieran estos módulos: habilitarlos por defecto
        if (isLegacy) {
            for (const key of NEW_MODS) {
